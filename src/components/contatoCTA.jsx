    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-[#16275c40] to-[#002b5880]  py-24 px-6">
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        <div className="inline-block mb-4">
          <span className="px-4 py-2 rounded-full bg-cyan-500/20 text-cyan-300 text-sm font-medium border border-cyan-400/30 backdrop-blur-sm">
            Vamos Conversar
          </span>
        </div>
        ...
        <p className="text-lg md:text-xl text-blue-100/80 mb-10 max-w-2xl mx-auto">
          Tem um projeto em mente? Estou pronto para ajudar a criar soluções
